    ...
    var vm = new Vue({
        ...
        filters: {
            ...
            replace_s_to_null: function(link) {
                if (link){
                    // 将tags_articles替换tag就可以返回模板
                    return link.replace('tags_articles', 'tag');
                } else {
                    return link
                }
            },
        ...
        methods: {
            ...
            get_article_list: function () {
                ...
                axios.get(this.host + '/tags_articles/' + document.location.search, {
                    responseType: 'json'
                })
                    .then(response => {
                        this.article_tag = response.data;
            ...
            format_page_num: function (cid, page_num, size_num) {
                ...
                return this.host + '/tags_articles/?cid=' + cid + '&page=' + page_num + '&size=' + size_num
            },
            // 刷新当前页面
