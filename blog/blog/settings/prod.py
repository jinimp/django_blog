...
# ------------------------------ 配置中间件 ------------------------------ #
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # 解决跨域的第三方包
...
QQ_REDIRECT_URI = 'http://www.linjinquan.com/qqlogin'  # 登录成功后的回调网址
...
# MEDIA_ROOT的作用是指定后台上传的图片实际存储的目录是/uploads
MEDIA_ROOT = os.path.join(BASE_DIR, 'uploads')
# MEDIA_URL的作用是对外显示是/media这个路径
MEDIA_URL = '/media/'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://172.18.189.7:9200/',  # 此处为elasticsearch运行的服务器ip地址，端口号固定为9200
